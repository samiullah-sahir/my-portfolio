...
const hljs = (function () {
  const e = { exports: {} }; function t(e) {
    return e instanceof Map ? e.clear = e.delete = e.set = () => {
      ...
      const i = e[n];
      typeof i !== 'object' || Object.isFrozen(i) || t(i);
    })), e;
  }
  ...
  const s = (e) => !!e.scope || e.sublanguage && e.language; class o {
    ...
    closeNode(e) { s(e) && (this.buffer += '</span>'); }
    ...
    static _walk(e, t) {
      return typeof t === 'string' ? e.addText(t) : t.children && (e.openNode(t),
  ...
  function E(e, { joinWith: t }) {
    let n = 0; return e.map(((e) => {
      n += 1; const t = n;
      let i = g(e); let r = ''; for (;i.length > 0;) {
  ...
  const x = '[a-zA-Z]\\w*'; const w = '[a-zA-Z_]\\w*'; const y = '\\b\\d+(\\.\\d+)?'; const _ = '(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)'; const O = '\\b(0b[01]+)'; const v = { begin: '\\\\[\\s\\S]', relevance: 0 }; const N = {
    scope: 'string',
    begin: "'",
    end: "'",
    illegal: '\\n',
  ...
  }; const S = M('//', '$'); const R = M('/\\*', '\\*/'); const j = M('#', '$'); const A = Object.freeze({
    __proto__: null,
    ...
    SHEBANG: (e = {}) => {
      ...
      return e.binary && (e.begin = p(t, /.*\b/, e.binary, /\b.*/)), r({
        ...
        relevance: 0,
        'on:begin': (e, t) => { e.index !== 0 && t.ignoreMatch(); },
      }, e);
    },
    BACKSLASH_ESCAPE: v,
    APOS_STRING_MODE: N,
    ...
    const n = { ...e }; Object.keys(e).forEach(((t) => {
      delete e[t];
    })), e.keywords = n.keywords, e.begin = p(n.beforeMatch, d(n.begin)), e.starts = {
      relevance: 0, contains: [Object.assign(n, { endsParent: !0 })],
    }, e.relevance = 0, delete n.beforeMatch;
  }; const C = ['of', 'and', 'for', 'in', 'not', 'or', 'if', 'then', 'parent', 'list', 'value'];
  function $(e, t, n = 'keyword') {
    const i = Object.create(null);
    return typeof e === 'string' ? r(n, e.split(' ')) : Array.isArray(e) ? r(n, e) : Object.keys(e).forEach(((n) => {
    ...
    console.error(e);
  }; const W = (e, ...t) => { console.log(`WARN: ${e}`, ...t); }; const X = (e, t) => {
    z[`${e}/${t}`] || (console.log(`Deprecated as of ${e}. ${t}`), z[`${e}/${t}`] = !0);
  }; const G = Error(); function Z(e, t, { key: n }) {
    let i = 0; const r = e[n]; const s = {}; const o = {};
    ...
    ((e) => {
      ...
      delete e.scope);
    })(e), typeof e.beginScope === 'string' && (e.beginScope = { _wrap: e.beginScope }), typeof e.endScope === 'string' && (e.endScope = { _wrap: e.endScope }), ((e) => {
    ...
    function t(t, n) {
      ...
      compile() {
        ...
        const e = this.regexes.map(((e) => e[1])); this.matcherRe = t(E(e, { joinWith: '|' }), !0), this.lastIndex = 0;
      }

      exec(e) {
        this.matcherRe.lastIndex = this.lastIndex;
        const t = this.matcherRe.exec(e); if (!t) return null;
        const n = t.findIndex(((e, t) => t > 0 && void 0 !== e)); const i = this.matchIndexes[n];
    ...
    return e.classNameAliases = r(e.classNameAliases || {}), (function n(s, o) {
      ...
      return typeof s.keywords === 'object' && s.keywords.$pattern && (s.keywords = { ...s.keywords },
      ...
      s.contains || (s.contains = []), s.contains = [].concat(...s.contains.map(((e) => ((e) => (e.variants && !e.cachedVariants && (e.cachedVariants = e.variants.map(((t) => r(e, { variants: null }, t)))), e.cachedVariants ? e.cachedVariants : q(e) ? r(e, {
        starts: e.starts ? r(e.starts) : null,
      }) : Object.isFrozen(e) ? r(e) : e))(e === 'self' ? s : e)))), s.contains.forEach(((e) => {
        n(e, a);
  ...
  const Y = i; const Q = r; const ee = Symbol('nomatch'); const te = ((t) => {
    const i = Object.create(null); const r = Object.create(null); const s = []; let o = !0;
    const a = "Could not find the language '{}', did you forget to load/include a language module?"; const c = { disableAutodetect: !0, name: 'Plain text', contains: [] }; let g = {
      ...
      const c = Object.create(null); function l() {
        ...
        let e = 0; N.keywordPatternRe.lastIndex = 0; let t = N.keywordPatternRe.exec(S); let n = '';
        for (;t;) {
          n += S.substring(e, t.index);
          const r = y.case_insensitive ? t[0].toLowerCase() : t[0]; const s = (i = r, N.keywords[i]); if (s) {
            const [e, i] = s;
        ...
        N.subLanguage != null ? (() => {
          if (S === '') return; let e = null; if (typeof N.subLanguage === 'string') {
        ...
        let n = 1; const i = t.length - 1; for (;n <= i;) {
          if (!e._emit[n]) { n++; continue; } const i = y.classNameAliases[e[n]] || e[n]; const r = t[n];
          i ? M.addKeyword(r, i) : (S = r, l(), S = ''), n++;
        }
      } function h(e, t) {
        return e.scope && typeof e.scope === 'string' && M.openNode(y.classNameAliases[e.scope] || e.scope),
        e.beginScope && (e.beginScope._wrap ? (M.addKeyword(S, y.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap),
        S = '') : e.beginScope._multi && (u(e.beginScope, t), S = '')), N = Object.create(e, { parent: { value: N } }), N;
      } function p(e, t, i) {
        let r = ((e, t) => {
          const n = e && e.exec(t);
          return n && n.index === 0;
        ...
        return N.matcher.regexIndex === 0 ? (S += e[0], 1) : (I = !0, 0);
      } function b(e) {
        const n = e[0]; const i = t.substring(e.index); const r = p(N, e, i); if (!r) return ee; const s = N;
      ...
      let m = {}; function w(i, s) {
        const a = s && s[0]; if (S += i, a == null) return d(), 0;
        if (m.type === 'begin' && s.type === 'end' && m.index === s.index && a === '') {
        ...
        if (m = s, s.type === 'begin') {
          return ((e) => {
            const t = e[0]; const i = e.rule; const r = new n(i); const s = [i.__beforeBegin, i['on:begin']];
        ...
        if (s.type === 'illegal' && !r) {
          ...
          throw e.mode = N, e;
        } if (s.type === 'end') { const e = b(s); if (e !== ee) return e; }
        if (s.type === 'illegal' && a === '') return 1;
        if (A > 1e5 && A > 3 * s.index) throw Error('potential infinite loop, way more iterations than matches');
        return S += a, a.length;
      } const y = O(e);
      if (!y) throw K(a.replace('{}', e)), Error(`Unknown language: "${e}"`);
      const _ = V(y); let v = ''; let N = s || _; const k = {}; const M = new g.__emitter(g); (() => {
        const e = [];
        for (let t = N; t !== y; t = t.parent)t.scope && e.unshift(t.scope);
        e.forEach(((e) => M.openNode(e)));
      })(); let S = ''; let R = 0; let j = 0; let A = 0; let I = !1; try {
      ...
      t = t || g.languages || Object.keys(i); const n = ((e) => {
        const t = {
          value: Y(e), illegal: !1, relevance: 0, _top: c, _emitter: new g.__emitter(g),
        };
        return t._emitter.addText(e), t;
      })(e); const r = t.filter(O).filter(N).map(((t) => E(t, e, !1)));
      ...
      if (k('before:highlightElement', { el: e, language: n }), e.children.length > 0 && (g.ignoreUnescapedHTML || (console.warn('One of your code blocks includes unescaped HTML. This is a potentially serious security risk.'),
      console.warn('https://github.com/highlightjs/highlight.js/wiki/security'),
      console.warn('The element with unescaped HTML:'),
      console.warn(e)), g.throwUnescapedHTML)) throw new J('One of your code blocks includes unescaped HTML.', e.innerHTML);
      t = e; const i = t.textContent; const s = n ? m(i, { language: n, ignoreIllegals: !0 }) : x(i);
      ...
      document.readyState !== 'loading' ? document.querySelectorAll(g.cssSelector).forEach(w) : y = !0;
    ...
    typeof window !== 'undefined' && window.addEventListener && window.addEventListener('DOMContentLoaded', (() => {
      ...
      registerLanguage: (e, n) => {
        ...
        r.name || (r.name = e), i[e] = r, r.rawDefinition = n.bind(null, t), r.aliases && v(r.aliases, { languageName: e });
      },
      ...
      optional: h,
      anyNumberOfTimes: u,
    }; for (const t in A) typeof A[t] === 'object' && e.exports(A[t]);
    return Object.assign(t, A), t;
  })({}); return te;
}());
typeof exports === 'object' && typeof module !== 'undefined' && (module.exports = hljs);/*! `xml` grammar compiled for Highlight.js 11.6.0 */
(() => {
  const e = (() => (e) => {
    const a = e.regex; const n = a.concat(/[\p{L}_]/u, a.optional(/[\p{L}0-9_.-]*:/u), /[\p{L}0-9_.-]*/u); const s = { className: 'symbol', begin: /&[a-z]+;|&#[0-9]+;|&#x[a-f0-9]+;/ }; const t = {
      begin: /\s/,
      contains: [{ className: 'keyword', begin: /#?[a-z_][a-z1-9_-]+/, illegal: /\n/ }],
    }; const i = e.inherit(t, { begin: /\(/, end: /\)/ }); const c = e.inherit(e.APOS_STRING_MODE, { className: 'string' }); const l = e.inherit(e.QUOTE_STRING_MODE, { className: 'string' }); const r = {
      endsWithParent: !0,
      illegal: /</,
      relevance: 0,
      contains: [{
        ...
        begin: /=\s*/,
        relevance: 0,
        contains: [{ className: 'string', endsParent: !0, variants: [{ begin: /"/, end: /"/, contains: [s] }, { begin: /'/, end: /'/, contains: [s] }, { begin: /[^\s"'=<>`]+/ }] }],
      }],
    }; return {
      name: 'HTML, XML',
      ...
      }, { className: 'tag', begin: a.concat(/<\//, a.lookahead(a.concat(n, />/))), contains: [{ className: 'name', begin: n, relevance: 0 }, { begin: />/, relevance: 0, endsParent: !0 }] }],
    };
